# transform-landing-no-js.ps1
$file = "c:\Users\priya\OneDrive\Desktop\vritti\public\landing.html"
$content = [System.IO.File]::ReadAllText($file)

# Remove modulepreload links and main module script to disable React Hydration
# This ensures our HTML edits stay intact and don't get overwritten by the original JS state
$content = $content -replace '<link rel="modulepreload"[^>]*>', ''
$content = $content -replace '<script type="module" async data-framer-bundle="main"[^>]*><\/script>', ''
...
Write-Host "Replaced HTML text and stripped React Hydration scripts."
