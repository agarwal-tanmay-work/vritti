# transform-landing.ps1
# Applies text replacements for Vritti across HTML and JS files
...
$replacements = @(
    ...
    @{ Old = 'Trusted already by 1\.2k\+'; New = 'Built with passion' }
    ...
    # ── 13. LINKS ──────────────────────────────────────────────────
    @{ Old = 'https://www\.framer\.com\?via=green13'; New = '/analyse' }
    @{ Old = 'https://easyframe\.framer\.website/'; New = '/about' }
    ...
    @{ Old = 'target="_blank" rel="noopener" href="/analyse"'; New = 'href="/analyse"' }
    @{ Old = 'target="_blank" rel="noopener" href="/about"'; New = 'href="/about"' }
